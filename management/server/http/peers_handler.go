...
func (h *PeersHandler) updatePeer(ctx context.Context, account *server.Account, userID string, peerID string, w http.ResponseWriter, r *http.Request) {
	req := &api.PeerRequest{}
...
func (h *PeersHandler) HandlePeer(w http.ResponseWriter, r *http.Request) {
	...
	case http.MethodDelete:
		h.deletePeer(r.Context(), claims.AccountId, claims.UserId, peerID, w)
		return
	case http.MethodGet, http.MethodPut:
		...
		if r.Method == http.MethodGet {
			h.getPeer(r.Context(), account, peerID, claims.UserId, w)
		} else {
			h.updatePeer(r.Context(), account, claims.UserId, peerID, w, r)
		}
		return
	default:
